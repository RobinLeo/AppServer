...
/**
 * L OR R 开头的方法用于list, l表示 left,r表示right SADD 为 set添加元素, smembers为获取set中所有元素。 SISMEMBER 判断是否为set中的一个元素 H 开头的为 hashmap
 * HSET key 同 SETNX的区别，nx表示仅仅当cache中不存在该值时才set.
 * 
 * @author jeffrey
 */
